...
<body>
	...
	<div class="container p-4">
		<div class="row">
			...
			<option value = "Neurologist">Neurologist (Brain & Nervous System Specialist)</option>
			<option value = "Orthopedic Surgeon">Orthopedic Surgeon (Bone & Joint Specialist)</option>
			<option value = "Dermatologist">Dermatologist (Skin Specialist)</option>
			<option value = "Gastroenterologist">Gastroenterologist (Digestive System Specialist)</option>
			<option value = "Oncologist">Oncologist (Cancer Specialist)</option>
			<option value = "Endocrinologist">Endocrinologist (Hormone & Diabetes Specialist)</option>
			<option value = "Pulmonologist">Pulmonologist (Lung Specialist)</option>
			<option value = "Nephrologist">Nephrologist (Kidney Specialist)</option>
			<option value = "Urologist">Urologist (Urinary System Specialist)</option>
			...
			<option value = "Psychiatrist">Psychiatrist (Mental Health Specialist)</option>
			<option value = "Rheumatologist">Rheumatologist (Arthritis & Autoimmune Disease Specialist)</option>
